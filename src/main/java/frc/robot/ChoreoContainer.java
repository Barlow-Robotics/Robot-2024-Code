...
//         traj = Choreo.loadTrajectory("Test1");
//         // traj.get()
//         Command swerveCommand = Choreo.choreoSwerveCommand(
//             // traj.get(), // Choreo trajectory
...
//         Optional<Pose2d> optionalPose = traj.get().getInitialPose(isRedAlliance());
//         Pose2d pose = optionalPose.orElse(new Pose2d()) ;

//         return Commands.sequence(
//             Commands.runOnce(() -> driveSub.resetOdometry(pose)),
//             swerveCommand,
